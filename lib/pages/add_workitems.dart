...
// import 'package:yes_broker/constants/firebase/questionModels/inventory_question.dart' as invent;
// import 'package:yes_broker/constants/firebase/questionModels/lead_question.dart' as lead;
...
//   late Future<List<invent.InventoryQuestions>> getInventoryQuestions;
//   late Future<List<lead.LeadQuestions>> getLeadQuestions;
...
//       getInventoryQuestions = invent.InventoryQuestions.getAllQuestionssFromFirestore();
//     } else {
//       getLeadQuestions = lead.LeadQuestions.getAllQuestionssFromFirestore();
//     }
...
//   invent.InventoryQuestions? getcurrentInventory(AsyncSnapshot<List<dynamic>> snapshot, option) {
...
//   lead.LeadQuestions? getCurrentLead(AsyncSnapshot<List<dynamic>> snapshot, option) {
//     for (var data in snapshot.data!) {
//       if (data.type == option) {
//         return data;
//       }

...
Future<void> firebaseMessagingBackgroundHandler(RemoteMessage message) async {
  ...
  AndroidNotificationDetails androidDetails =
      const AndroidNotificationDetails('brokr-in', 'Chat app', priority: Priority.max, importance: Importance.high, icon: "@mipmap/ic_launcher");
  NotificationDetails notifyDetails = NotificationDetails(android: androidDetails);
  await flutterLocalNotificationsPlugin.show(0, message.notification?.title, message.notification?.body, notifyDetails);
  ...
  if (!kIsWeb) {
    ...
    if (notification != null && android != null) {
      ...
      flutterLocalNotificationsPlugin.show(
        ...
        notification.body,
        NotificationDetails(
          android: AndroidNotificationDetails(channel.id, channel.name, channelDescription: channel.description, icon: ""),
        ),
      );
      print("after");
    }

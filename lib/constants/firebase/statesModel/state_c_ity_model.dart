...
final CollectionReference statescollection = FirebaseFirestore.instance.collection('states');

class StateCItyModel {
  List<States>? states;

  StateCItyModel({this.states});
  ...
  Map<String, dynamic> toJson() {
    ...
    if (states != null) {
      data["states"] = states?.map((e) => e.toJson()).toList();
    }
    return data;
  }

  static Future<void> addDataToFirestore() async {
    try {
      // Iterate through the states and add them to Firestore
      for (var stateData in jsonData['states']) {
        await statescollection.add(stateData);
      }
  ...
  static Future<List<States>> getAllStates() async {
    List<States> statesList = [];
    try {
      QuerySnapshot querySnapshot = await statescollection.get();
      for (QueryDocumentSnapshot documentSnapshot in querySnapshot.docs) {
        Map<String, dynamic> data = documentSnapshot.data() as Map<String, dynamic>;
        States state = States.fromJson(data);
        statesList.add(state);
      }
      return statesList;
    } catch (e) {
      print("Error getting states from Firestore: $e");
      return statesList; // Return an empty list or handle the error as needed
    }
  }
}
...
class States {
  ...
  States.fromJson(Map<String, dynamic> json) {
    ...
    if (json["districts"] is List) {
      districts = json["districts"] == null ? null : List<String>.from(json["districts"]);
    }
  }

...
//             decoration: BoxDecoration(borderRadius: BorderRadius.circular(10), color: hovered && !widget.selected ? AppColor.secondary : Colors.transparent),
//             child: Center(
//               child: Icon(
//                 widget.icon,
...
//     path.quadraticBezierTo(101, value1 + 20, animValue3, value1 + 20); // have to use animValue3 for x2
//     path.lineTo(animValue1, value1 + 20); // have to use animValue1 for x
//     path.quadraticBezierTo(animValue2, value1 + 20, animValue2, value1 + 40); // animValue2 = 25 // have to use animValue2 for both x
